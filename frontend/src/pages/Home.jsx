...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f0f7ff]">
      {/* Hero Section */}
      <div className="relative flex h-screen w-full bg-gradient-to-b from-orange-300 to-orange-100 text-white  p-10 flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 relative h-full flex items-center justify-center">
          <div className="absolute right-0 left-110 top-72 w-67 h-67 rounded-full bg-white overflow-hidden">
            <img
              src={images[0]}
              alt="Service 1"
          ...
          <div className="absolute right-53 top-7 w-65 h-65 rounded-full bg-yellow-400 overflow-hidden">
            <img
              src={images[1]}
              alt="Service 2"
              className="w-full h-full object-cover"
          ...
          <div className="absolute right-80 bottom-20 w-91 h-91 rounded-full bg-green-400 overflow-hidden">
            <img
              src={images[2]}
              alt="Service 3"
              className="w-full h-full object-cover"
          ...
          <div className="absolute right-135  top-10 w-63  h-63 rounded-full bg-yellow-400 overflow-hidden">
            <img
              src={images[3]}
              alt="Service 4"
