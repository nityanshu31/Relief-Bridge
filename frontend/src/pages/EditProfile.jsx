...
const EditProfile = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await fetch("https://backend-l7fu.onrender.com/api/auth/profile", {
          method: "GET",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://backend-l7fu.onrender.com/api/auth/edit-profile", {
        method: "PUT",
        headers: {
